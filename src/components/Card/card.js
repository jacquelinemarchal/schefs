...
const Card = () => {
    ...
    return (
        <>
        <div onClick={() => cardContext.cardDispatch("closeCard")} className="fixed inset-0 transition-opacity z-10">
        ...
        <div className="fixed m-2 rounded-xl top-0 sm:mt-10 lg:w-4/12 h-auto bg-white justify-center sm:right-0 z-20" style={{height: "84vh"}}>
            <div className="flex justify-end">
                <button onClick={() => cardContext.cardDispatch("closeCard")} className="focus:outline-none p-2">
                    <HighlightOff/>
                </button>
            </div>
