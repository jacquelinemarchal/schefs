    ...
    return (
        <>
          ...
          <div className="px-2 mx-6 md:mx-12 xl:mx-24">
            <div className="w-full relative flex flex-row justify-between items-center" style={{height: '40rem'}}>
              <p className="text-4xl leading-tight pl-32">
            ...
            <div className="w-full relative flex flex-row justify-center items-center" style={{height: '20rem'}}>
            ...
            <div className="w-full relative mt-16" style={{height: '76rem'}}>
              ...
              <svg className="absolute" style={{top: '68%', left: '28%'}} width="350" height="320" viewBox="0 0 479 302" fill="none" xmlns="http://www.w3.org/2000/svg">
