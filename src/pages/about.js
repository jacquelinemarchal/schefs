          ...
          <div className="px-2 mx-6 md:mx-12 xl:mx-24">
            ...
            <div className="lg:block hidden">
              ...
              <svg className="absolute" style={{top: '41%', left: '33%'}} width="330" height="170" viewBox="0 0 463 243" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M460.629 1.80176C362.757 1.80176 250.614 22.3946 165.632 73.0225C106.051 108.517 28.1187 169.071 5.49023 236.957V206.614M1.69751 240.749C7.92814 236.218 21.3946 231.698 24.4544 225.578" stroke="#FF0000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              ...
              <svg className="absolute" id="threeToFourArrow" width="300" height="290" viewBox="0 0 479 302" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.39893 2.33008C18.6587 49.3027 49.484 97.5474 86.2624 131.497C128.651 170.625 180.064 208.604 234.604 229.057C294.086 251.362 351.449 266.881 413.499 280.892C424.12 283.29 471.89 281.361 476.502 290.585C471.245 283.357 465.145 275.456 461.331 267.828M475.782 290.284C471.069 291.15 464.908 291.658 461.148 294.666C458.864 296.493 456.585 298.826 453.948 300.145" stroke="#FF0000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            ...
            <div className="w-full relative flex flex-row justify-center" style={{height: '30rem'}}>
              <div className="relative mx-40 mt-16" style={{maxWidth: '28%'}}>
                ...
                <svg width="240" height="25" viewBox="0 0 299 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M2 27.7058C43.1673 20.2208 83.9535 4.62738 126.367 4.62738C147.037 4.62738 167.578 2.06311 188.622 2.06311C225.74 2.06311 260.998 0.782751 296.89 9.75591" stroke="#FF0000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            ...
            <div className="w-full my-16 flex flex-row gap-x-32 justify-center">
              ...
              <div className="w-1/2">
                ...
                <p className="text-xl">
                Schefs started in January 2020 as a bunch of students at Columbia hosting meals in their dorm rooms open to any Columbia student. &ldquo;Novel dining experiences,&rdquo; we called them&#8212;for instance, the &ldquo;Psychodrama Dinner Theater&rdquo; (shoutout Alex Levene), a live-action play during a multi-course meal. The vision was to use food as a mechanism for meeting new people an an intimate and interesting way. Then Covid happened&#8212;we were all sent home&#8212;and so we started running Schefs events virtually. We were no longer bound by geography, so we opened it up to undergrad students from any school. And from there, Schefs quickly became a space for young people around the world to meet and jam on shared topics of interest, and to most importantly, learn from each other.
                </p>
              </div>
            </div>
