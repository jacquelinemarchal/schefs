...
import zoomMobileCollage from '../assets/zoomPicMobile.png'
...
const hostButtonFunction = () => {
    ...
    if (context.profile){ // if user has acct
        ...
        <>
          ...
          <div className="px-2 mx-6 md:mx-12 xl:mx-24">
            <div className="lg:hidden block">
                <p className="sm:text-4xl text-2xl text-center leading-tight pl-22 mt-10 mb-8">
                    Take what you know.<br/>
                    Share it with others.<br/>
                    Learn from each other.
                </p>
                <img src={zoomMobileCollage} className="block w-full h-auto my-6" alt="Zoom collage" style={{maxHeight: '100%', alignSelf: 'center', justifySelf: 'center'}}></img>
                <p className="text-lg sm:text-2xl leading-tight text-left mx-8 mb-10 mt-12">
            ...
            <div className="hidden lg:flex relative w-full flex-row justify-between items-center" style={{height: '30rem'}}>
              <p className="text-4xl leading-tight pl-22">
                Take what you know.<br/>
                Share it with others.<br/>
                Learn from each other.
              </p>
              <img src={zoomCollage} className="block w-auto h-auto" alt="Zoom collage" style={{maxWidth: '50%', maxHeight: '100%', alignSelf: 'center'}}></img>
            </div>
            ...
            <div className="lg:block hidden">
                ...
                <div className="absolute" style={{maxWidth: '28%', left: '15%', top: '45%'}}>
                ...
                <div className="absolute" style={{maxWidth: '28%', right: '15%', top: '65%'}}>
                ...
                <p className="text-4xl">Words of encouragement:</p>
                <div className="w-full flex flex-row justify-items-stretch mt-4 mb-16">
                    ...
                    <svg className="absolute" style={{bottom: 0, left: '-2%'}} width="90" height="30" viewBox="0 0 215 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M16.9917 62.0021C56.5323 62.0021 96.4392 63.5322 135.755 60.3869C146.443 59.5319 157.404 55.5489 167.868 55.1614C178.238 54.7773 188.118 50.5949 198.272 50.0308C211.054 49.3206 219.072 30.2022 205.968 24.378C197.533 20.6293 188.619 17.8753 180.315 13.2617C174.534 10.0502 165.53 5.56589 158.937 5.56589C149.069 5.56589 138.561 2.14551 128.534 2.14551C119.983 2.14551 111.432 2.14551 102.881 2.14551C93.3484 2.14551 83.8157 2.14551 74.283 2.14551C61.909 2.14551 50.8505 8.35217 39.1291 10.6965C28.2174 12.8788 2.48426 19.6061 1.59997 34.6391C1.10635 43.0306 2.58643 46.2083 10.1509 50.4108C15.2993 53.271 18.7155 59.4436 23.8324 62.0021" stroke="#FF0000" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    </p>
                    <p className="text-xl">
                ...
                <p className="text-4xl">How did this start?</p>
            ...
            <div className="lg:hidden">
                ...
                <div className="mt-12">
                    ...
                    <ul className="list-disc list-inside mt-8" style={{marginLeft: '3.5rem',}}>
                ...
                <div className="my-12">
                    <svg className="absolute" style={{left: '20%',}} width="100" height="50" viewBox="0 0 312 157" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M188.678 120.55C152.213 120.55 116.32 123.545 79.8402 123.545C55.902 123.545 31.764 125.697 10.8087 116.888C-1.62989 111.66 2.74666 96.2016 2.74666 87.5974C2.74666 56.7502 20.2234 40.3583 62.7083 27.6839C87.2505 20.3624 113.08 11.4504 138.794 6.21497C161.318 1.62905 187.74 1.47238 211.101 2.55359C243.281 4.04297 286.033 15.5977 304.192 34.341C322.821 53.5685 292.667 70.864 269.677 81.606C232.014 99.2033 188.324 109.281 145.974 120.633C108.013 130.809 71.946 144.004 34.491 155" stroke="#FF0000" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p className="text-4xl sm:text-6xl mx-12 leading-tight">Schefs is<br />NOT...</p>
                    <ul className="list-disc list-inside mt-8" style={{marginLeft: '3.5rem',}}>
                ...
                <div className="text-center">
                    <p className="text-xl sm:text-3xl mt-4 mb-2">Interested?</p>
